package com.luaye.console.view
{
   ...
   public class PanelsManager
   {
      ...
      public function PanelsManager(master:Console, mp:MainPanel)
      {
         ...
         this._tooltipField.autoSize = "center";
      ...
      public function addPanel(panel:AbstractPanel) : void
      {
         ...
         panel.addEventListener("startedDragging",this.onPanelStartDragScale,false,0,true);
         panel.addEventListener("startedScaling",this.onPanelStartDragScale,false,0,true);
      }
      ...
      {
         return !!(this.getPanel("channelsPanel") as ChannelsPanel) ? true : false;
      }
      ...
      public function set channelsPanel(b:Boolean) : void
      {
         ...
         if(this.channelsPanel != b)
         {
            ...
            {
               this.removePanel("channelsPanel");
               this.updateMenu();
            }
         }
      }
      ...
      public function updateMenu() : void
      {
         ...
         var chpanel:ChannelsPanel = this.getPanel("channelsPanel") as ChannelsPanel;
         if(chpanel)
         {
            chpanel.update();
         }
      ...
      {
         return !!(this.getPanel("rollerPanel") as RollerPanel) ? true : false;
      }
      ...
      {
         return this.getPanel("fpsPanel") as FPSPanel != null;
      }
      ...
      {
         return this.getPanel("memoryPanel") as MemoryPanel != null;
      }
      ...
      {
         n = "graph_" + n;
         var graph:GraphingPanel;
         if(!(graph = this.getPanel(n) as GraphingPanel))
         {
            (graph = new GraphingPanel(this._master,100,100)).x = this._mainPanel.x + 80;
      ...
      {
         var graph:GraphingPanel;
         if(graph = this.getPanel("graph_" + n) as GraphingPanel)
         {
      ...
      public function tooltip(str:String = null, panel:AbstractPanel = null) : void
      {
         ...
         if(str && !this.rulerActive)
         {
            ...
            if(panel)
            {
               ...
               if((doff = txtRect.bottom - panRect.bottom) > 0)
               {
      ...
      public function startRuler() : void
      {
         ...
         this._ruler.addEventListener("exit",this.onRulerExit,false,0,true);
      ...
      private function onPanelStartDragScale(e:Event) : void
      {
         ...
         var target:AbstractPanel;
         if((target = e.currentTarget as AbstractPanel).snapping)
         {
            X = [0];
            Y = [0];
            ...
            {
               if((panel = this._master.getChildAt(i) as AbstractPanel) && panel.visible)
               {
                  X.push(panel.x);
