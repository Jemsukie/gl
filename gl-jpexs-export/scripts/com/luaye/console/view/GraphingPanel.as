package com.luaye.console.view
{
   ...
   public class GraphingPanel extends AbstractPanel
   {
      ...
      public function GraphingPanel(m:Console, W:int = 0, H:int = 0, resizable:Boolean = true)
      {
         ...
         this.keyTxt.y = -3;
         this.keyTxt.addEventListener("link",this.linkHandler,false,0,true);
         registerRollOverTextField(this.keyTxt);
         this.keyTxt.addEventListener("textLinkEvent",this.onMenuRollOver,false,0,true);
      ...
      {
         var cur:Number = Number(obj[prop]);
         if(!isNaN(cur))
         {
      ...
      public function start() : void
      {
         ...
         addEventListener("enterFrame",this.onFrame,false,0,true);
      }
      
      public function stop() : void
      {
         this._isRunning = false;
         removeEventListener("enterFrame",this.onFrame);
      }
      ...
      protected function getCurrentOf(i:int) : Number
      {
         ...
         return !!values ? Number(values[i]) : 0;
      }
      ...
      public function drawGraph() : void
      {
         ...
         var numInterests:int = int(this._interests.length);
         var len:int = int(this._history.length);
         for(j = 0; j < numInterests; )
         {
...
class Interest
{
   ...
   public function Interest(object:Object, property:String, color:Number, keystr:String)
   {
      super();
