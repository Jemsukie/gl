package com.luaye.console.view
{
   ...
   public class RollerPanel extends AbstractPanel
   {
      ...
      public function RollerPanel(m:Console)
      {
         ...
         this._txtField.autoSize = "left";
         this._txtField.styleSheet = style.css;
         this._txtField.addEventListener("link",this.linkHandler,false,0,true);
         registerRollOverTextField(this._txtField);
         this._txtField.addEventListener("textLinkEvent",this.onMenuRollOver,false,0,true);
      ...
      {
         this._base = base;
         addEventListener("enterFrame",this._onFrame,false,0,true);
      }
      ...
      {
         removeEventListener("enterFrame",this._onFrame);
         this._base = null;
         super.close();
