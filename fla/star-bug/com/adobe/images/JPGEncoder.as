   ...
   public class JPGEncoder
   {
      ...
      private function RGB2YUV(param1:BitmapData, param2:int, param3:int) : void
      {
         ...
         while(_loc6_ < 8)
         {
            ...
            while(_loc5_ < 8)
            {
               _loc7_ = (_loc9_ = param1.getPixel32(param2 + _loc5_,param3 + _loc6_)) >> 16 & 255;
               _loc4_ = _loc9_ >> 8 & 255;
               _loc8_ = _loc9_ & 255;
               this.YDU[_loc10_] = 0.299 * _loc7_ + 0.587 * _loc4_ + 0.114 * _loc8_ - 128;
               this.UDU[_loc10_] = -0.16874 * _loc7_ + -0.33126 * _loc4_ + 0.5 * _loc8_;
               this.VDU[_loc10_] = 0.5 * _loc7_ + -0.41869 * _loc4_ + -0.08131 * _loc8_;
               _loc10_++;
               _loc5_++;
            }
            _loc6_++;
      ...
      public function encode(param1:BitmapData) : ByteArray
      {
         ...
         while(_loc3_ < param1.height)
         {
            ...
            {
               this.RGB2YUV(param1,_loc2_,_loc3_);
               _loc5_ = this.processDU(this.YDU,this.fdtbl_Y,_loc5_,this.YDC_HT,this.YAC_HT);
               _loc7_ = this.processDU(this.UDU,this.fdtbl_UV,_loc7_,this.UVDC_HT,this.UVAC_HT);
         ...
         if(this.bytepos >= 0)
         {
            (_loc4_ = new BitString()).len = this.bytepos + 1;
            _loc4_.val = 1 << this.bytepos + 1 - 1;
            this.writeBits(_loc4_);
         }
      ...
      private function initCategoryNumber() : void
      {
         ...
         while(_loc3_ <= 15)
         {
            ...
            while(_loc4_ < _loc1_)
            {
               this.category[32767 + _loc4_] = _loc3_;
               this.bitcode[32767 + _loc4_] = new BitString();
               this.bitcode[32767 + _loc4_].len = _loc3_;
               this.bitcode[32767 + _loc4_].val = _loc4_;
               _loc4_++;
            }
            _loc4_ = -(_loc1_ - 1);
            while(_loc4_ <= -_loc2_)
            {
               ...
               this.bitcode[32767 + _loc4_] = new BitString();
               this.bitcode[32767 + _loc4_].len = _loc3_;
               this.bitcode[32767 + _loc4_].val = _loc1_ - 1 + _loc4_;
               _loc4_++;
            }
            _loc2_ <<= 1;
            _loc1_ <<= 1;
      ...
      private function processDU(param1:Array, param2:Array, param3:Number, param4:Array, param5:Array) : Number
      {
         ...
         var _loc11_:* = 0;
         var _loc14_:int = 0;
         var _loc7_:BitString = param5[0];
         var _loc9_:BitString = param5[240];
         var _loc6_:Array = this.fDCTQuant(param1,param2);
         _loc8_ = 0;
         while(_loc8_ < 64)
         {
            this.DU[this.ZigZag[_loc8_]] = _loc6_[_loc8_];
            _loc8_++;
         }
         var _loc12_:int = this.DU[0] - param3;
         ...
         {
            this.writeBits(param4[this.category[32767 + _loc12_]]);
            this.writeBits(this.bitcode[32767 + _loc12_]);
         }
         var _loc13_:int = 63;
         while(_loc13_ > 0 && this.DU[_loc13_] == 0)
         {
            _loc13_--;
         }
         if(_loc13_ == 0)
         ...
         {
            _loc10_ = _loc8_;
            while(this.DU[_loc8_] == 0 && _loc8_ <= _loc13_)
            {
               _loc8_++;
            }
            if((_loc11_ = _loc8_ - _loc10_) >= 16)
            {
               _loc14_ = 1;
               while(_loc14_ <= _loc11_ / 16)
               {
            ...
            this.writeBits(param5[_loc11_ * 16 + this.category[32767 + this.DU[_loc8_]]]);
      ...
      private function initQuantTables(param1:int) : void
      {
         ...
         while(_loc6_ < 64)
         {
            if((_loc8_ = Math.floor((_loc7_[_loc6_] * param1 + 50) / 100)) < 1)
            {
               _loc8_ = 1;
            }
            else if(_loc8_ > 255)
            ...
            this.YTable[this.ZigZag[_loc6_]] = _loc8_;
            _loc6_++;
         }
         ...
         while(_loc6_ < 64)
         {
            if((_loc8_ = Math.floor((_loc3_[_loc6_] * param1 + 50) / 100)) < 1)
            {
               _loc8_ = 1;
            }
            else if(_loc8_ > 255)
            ...
            this.UVTable[this.ZigZag[_loc6_]] = _loc8_;
            _loc6_++;
         }
         var _loc2_:Array = [1,1.387039845,1.306562965,1.175875602,1,0.785694958,0.5411961,0.275899379];
         _loc6_ = 0;
         var _loc5_:int = 0;
         while(_loc5_ < 8)
         {
            ...
            while(_loc4_ < 8)
            {
               this.fdtbl_Y[_loc6_] = 1 / (this.YTable[this.ZigZag[_loc6_]] * _loc2_[_loc5_] * _loc2_[_loc4_] * 8);
               this.fdtbl_UV[_loc6_] = 1 / (this.UVTable[this.ZigZag[_loc6_]] * _loc2_[_loc5_] * _loc2_[_loc4_] * 8);
               _loc6_++;
               _loc4_++;
            }
            _loc5_++;
      ...
      private function computeHuffmanTbl(param1:Array, param2:Array) : Array
      {
         ...
         {
            _loc5_ = 1;
            while(_loc5_ <= param1[_loc3_])
            {
               _loc4_[param2[_loc6_]] = new BitString();
               _loc4_[param2[_loc6_]].val = _loc7_;
               _loc4_[param2[_loc6_]].len = _loc3_;
               _loc6_++;
               _loc7_++;
               _loc5_++;
            }
      ...
      private function fDCTQuant(param1:Array, param2:Array) : Array
      {
         ...
         while(_loc19_ < 8)
         {
            _loc10_ = param1[_loc14_ + 0] + param1[_loc14_ + 7];
            _loc16_ = param1[_loc14_ + 0] - param1[_loc14_ + 7];
            _loc9_ = param1[_loc14_ + 1] + param1[_loc14_ + 6];
            _loc3_ = param1[_loc14_ + 1] - param1[_loc14_ + 6];
            _loc6_ = param1[_loc14_ + 2] + param1[_loc14_ + 5];
            _loc7_ = param1[_loc14_ + 2] - param1[_loc14_ + 5];
            _loc5_ = param1[_loc14_ + 3] + param1[_loc14_ + 4];
            _loc8_ = param1[_loc14_ + 3] - param1[_loc14_ + 4];
            _loc18_ = _loc10_ + _loc5_;
            _loc22_ = _loc10_ - _loc5_;
            _loc13_ = _loc9_ + _loc6_;
            _loc15_ = _loc9_ - _loc6_;
            param1[_loc14_ + 0] = _loc18_ + _loc13_;
            param1[_loc14_ + 4] = _loc18_ - _loc13_;
            _loc23_ = (_loc15_ + _loc22_) * 0.707106781;
            param1[_loc14_ + 2] = _loc22_ + _loc23_;
            param1[_loc14_ + 6] = _loc22_ - _loc23_;
            _loc18_ = _loc8_ + _loc7_;
            _loc13_ = _loc7_ + _loc3_;
            _loc15_ = _loc3_ + _loc16_;
            _loc12_ = (_loc18_ - _loc15_) * 0.382683433;
            _loc20_ = 0.5411961 * _loc18_ + _loc12_;
            _loc11_ = 1.306562965 * _loc15_ + _loc12_;
            _loc21_ = _loc13_ * 0.707106781;
            _loc4_ = _loc16_ + _loc21_;
            _loc17_ = _loc16_ - _loc21_;
            param1[_loc14_ + 5] = _loc17_ + _loc20_;
            param1[_loc14_ + 3] = _loc17_ - _loc20_;
            param1[_loc14_ + 1] = _loc4_ + _loc11_;
            param1[_loc14_ + 7] = _loc4_ - _loc11_;
            _loc14_ += 8;
            _loc19_++;
         }
         _loc14_ = 0;
         ...
         while(_loc19_ < 8)
         {
            _loc10_ = param1[_loc14_ + 0] + param1[_loc14_ + 56];
            _loc16_ = param1[_loc14_ + 0] - param1[_loc14_ + 56];
            _loc9_ = param1[_loc14_ + 8] + param1[_loc14_ + 48];
            _loc3_ = param1[_loc14_ + 8] - param1[_loc14_ + 48];
            _loc6_ = param1[_loc14_ + 16] + param1[_loc14_ + 40];
            _loc7_ = param1[_loc14_ + 16] - param1[_loc14_ + 40];
            _loc5_ = param1[_loc14_ + 24] + param1[_loc14_ + 32];
            _loc8_ = param1[_loc14_ + 24] - param1[_loc14_ + 32];
            _loc18_ = _loc10_ + _loc5_;
            _loc22_ = _loc10_ - _loc5_;
            _loc13_ = _loc9_ + _loc6_;
            _loc15_ = _loc9_ - _loc6_;
            param1[_loc14_ + 0] = _loc18_ + _loc13_;
            param1[_loc14_ + 32] = _loc18_ - _loc13_;
            _loc23_ = (_loc15_ + _loc22_) * 0.707106781;
            param1[_loc14_ + 16] = _loc22_ + _loc23_;
            param1[_loc14_ + 48] = _loc22_ - _loc23_;
            _loc18_ = _loc8_ + _loc7_;
            _loc13_ = _loc7_ + _loc3_;
            _loc15_ = _loc3_ + _loc16_;
            _loc12_ = (_loc18_ - _loc15_) * 0.382683433;
            ...
            _loc4_ = _loc16_ + _loc21_;
            _loc17_ = _loc16_ - _loc21_;
            param1[_loc14_ + 40] = _loc17_ + _loc20_;
            param1[_loc14_ + 24] = _loc17_ - _loc20_;
            param1[_loc14_ + 8] = _loc4_ + _loc11_;
            param1[_loc14_ + 56] = _loc4_ - _loc11_;
            _loc14_++;
            _loc19_++;
         }
         _loc19_ = 0;
         while(_loc19_ < 64)
         {
            param1[_loc19_] = Math.round(param1[_loc19_] * param2[_loc19_]);
            _loc19_++;
         }
         return param1;
      }
